...
public class ParkingService implements IParkingService {
    ...
    public ParkedTicket ParkVehicle(Map<String, String> requestBody) {
        try {
            ...
            // Create and save the parked ticket (ID will be auto-generated by database)
    ...
    public UnparkedTicket UnparkVehicle(String ParkingTicketId, String userEmail) {
        try {
            ...
            Long ticketIdLong;
            try {
                ticketIdLong = Long.parseLong(ParkingTicketId);
            } catch (NumberFormatException e) {
                throw new ParkingLotException("Invalid ticket ID format.");
            }

            // Fetch the parked ticket
            ParkedTicket parkedTicket = parkedTicketRepository.findById(ticketIdLong).orElse(null);
            ...
            while (attempt < maxRetries && !success) {
                try {
                    ...
                    try {
                        ...
                        if (!parkedTicketRepository.existsById(ticketIdLong)) {
                            parkedTicketRepository.save(parkedTicket);
                        }
                    } catch (Exception rollbackException) {
    ...
    // This method is no longer needed with auto-increment Long IDs
    ...
    private String generateRandomId() {
        ...
        // No longer checking existsById since IDs are auto-generated by database
        return randomId;
    }
    ...
    public ParkedTicket UpdateParkedVehicle(String ticketId, String vehicleNo) {
        try {
            ...
            Long ticketIdLong;
            try {
                ticketIdLong = Long.parseLong(ticketId);
            } catch (NumberFormatException e) {
                throw new ParkingLotException("Invalid ticket ID format.");
            }
